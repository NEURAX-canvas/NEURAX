...
fn test_parallelism_implementation() {
    ...
    println!(
        "│ {:<30} │ {:<60} │",
        "rayon::join", "✓ Implemented (Phase 7 & 8)"
    );
    println!(
        "│ {:<30} │ {:<60} │",
        "Parallel Passes", "Parallelism + Hardware concurrent"
    );
    println!(
        "│ {:<30} │ {:<60} │",
        "Arc<Mutex<MetricsStore>>", "✓ Thread-safe metrics storage"
    );
    println!(
        "│ {:<30} │ {:<60} │",
        "Arc<Mutex<Diagnostics>>", "✓ Thread-safe diagnostics"
    );
    println!(
        "│ {:<30} │ {:<60} │",
        "NeuraxContext Arc", "✓ Shared context between threads"
    );
    println!("└─────────────────────────────────────────────────────────────────────────────────────────────────┘\n");
}
...
fn test_parallel_execution_speedup() {
    ...
    for i in 0..iterations {
        ...
        assert!(
            ...
            "Iteration {} should produce valid params",
            i
        );
    }
...
fn test_thread_safety() {
    ...
    for handle in handles {
        ...
        println!(
            "Thread {} completed: {} params, {} layers",
            thread_id, params, layers
        );
        assert!(
            params > 0,
            "Thread {} should produce valid params",
            thread_id
        );
    }
...
fn test_pipeline_phases() {
    ...
    println!(
        "│ {:<30} │ {:<30} │ {:<25} │",
        "Phase", "IR Module", "Status"
    );
    println!("├─────────────────────────────────────────────────────────────────────────────────────────────────┤");
    println!(
        "│ {:<30} │ {:<30} │ {:<25} │",
        "Phase 1", "ArchitectureIR", "✓ Sequential"
    );
    println!(
        "│ {:<30} │ {:<30} │ {:<25} │",
        "Phase 2", "GraphIR", "✓ Sequential"
    );
    println!(
        "│ {:<30} │ {:<30} │ {:<25} │",
        "Phase 3", "TensorIR", "✓ Sequential"
    );
    println!(
        "│ {:<30} │ {:<30} │ {:<25} │",
        "Phase 4", "OperatorIR", "✓ Sequential"
    );
    println!(
        "│ {:<30} │ {:<30} │ {:<25} │",
        "Phase 5", "ComputeIR", "✓ Sequential"
    );
    println!(
        "│ {:<30} │ {:<30} │ {:<25} │",
        "Phase 6", "MemoryIR", "✓ Sequential"
    );
    println!(
        "│ {:<30} │ {:<30} │ {:<25} │",
        "Phase 7 & 8", "ParallelismIR + HardwareIR", "✓ PARALLEL (rayon::join)"
    );
    println!(
        "│ {:<30} │ {:<30} │ {:<25} │",
        "Phase 9", "CostIR", "✓ Sequential"
    );
    println!(
        "│ {:<30} │ {:<30} │ {:<25} │",
        "Phase 10", "ReportIR", "✓ Sequential"
    );
    println!("└─────────────────────────────────────────────────────────────────────────────────────────────────┘\n");
