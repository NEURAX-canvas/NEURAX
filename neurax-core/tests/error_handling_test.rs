...
fn test_error_types_coverage() {
    ...
    println!(
        "│ {:<20} │ {:<35} │ {:<20} │",
        "Parser", "7 variants", "✓ Implemented"
    );
    println!(
        "│ {:<20} │ {:<35} │ {:<20} │",
        "Architecture", "5 variants", "✓ Implemented"
    );
    println!(
        "│ {:<20} │ {:<35} │ {:<20} │",
        "Graph", "4 variants", "✓ Implemented"
    );
    println!(
        "│ {:<20} │ {:<35} │ {:<20} │",
        "Tensor", "5 variants", "✓ Implemented"
    );
    println!(
        "│ {:<20} │ {:<35} │ {:<20} │",
        "Operator", "3 variants", "✓ Implemented"
    );
    println!(
        "│ {:<20} │ {:<35} │ {:<20} │",
        "Compute", "3 variants", "✓ Implemented"
    );
    println!(
        "│ {:<20} │ {:<35} │ {:<20} │",
        "Memory", "3 variants", "✓ Implemented"
    );
    println!(
        "│ {:<20} │ {:<35} │ {:<20} │",
        "Parallelism", "2 variants", "✓ Implemented"
    );
    println!(
        "│ {:<20} │ {:<35} │ {:<20} │",
        "Hardware", "3 variants", "✓ Implemented"
    );
    println!(
        "│ {:<20} │ {:<35} │ {:<20} │",
        "Cost", "2 variants", "✓ Implemented"
    );
    println!("├─────────────────────────────────────────────────────────────────────────────────────────────────┤");
    println!(
        "│ {:<20} │ {:<35} │ {:<20} │",
        "TOTAL", "37 error variants", "✓ Complete"
    );
    println!("└─────────────────────────────────────────────────────────────────────────────────────────────────┘\n");
}
...
fn test_parser_error_handling() {
    ...
    assert!(
        result.is_err(),
        "Missing schema_version should return error"
    );
...
fn test_diagnostic_codes() {
    ...
    use neurax_ir::{DiagnosticCategory, DiagnosticCode, Severity};
    ...
    println!(
        "│ {:<10} │ {:<20} │ {:<30} │ {:<15} │",
        "E001", "Memory", "OOM Risk", "Critical"
    );

    // E002: Shape Gate Blocked
    println!(
        "│ {:<10} │ {:<20} │ {:<30} │ {:<15} │",
        "E002", "Shape", "Shape Gate Blocked", "Error"
    );

    // W005: Memory Warning
    println!(
        "│ {:<10} │ {:<20} │ {:<30} │ {:<15} │",
        "W005", "Memory", "Memory Close to Limit", "Warning"
    );

    // W006: Low GPU Util
    println!(
        "│ {:<10} │ {:<20} │ {:<30} │ {:<15} │",
        "W006", "Performance", "Low GPU Utilization", "Warning"
    );

    // H001-H005: Hints
    println!(
        "│ {:<10} │ {:<20} │ {:<30} │ {:<15} │",
        "H001", "Parallelism", "Tensor Parallel Recommended", "Hint"
    );
    println!(
        "│ {:<10} │ {:<20} │ {:<30} │ {:<15} │",
        "H002", "Memory", "Gradient Checkpointing", "Hint"
    );
    println!(
        "│ {:<10} │ {:<20} │ {:<30} │ {:<15} │",
        "H003", "Parallelism", "Pipeline Parallelism", "Hint"
    );
    println!(
        "│ {:<10} │ {:<20} │ {:<30} │ {:<15} │",
        "H004", "Memory", "ZeRO-3 Recommended", "Hint"
    );
    println!(
        "│ {:<10} │ {:<20} │ {:<30} │ {:<15} │",
        "H005", "Memory", "ZeRO-3 Recommended", "Hint"
    );
...
fn test_thiserror_usage() {
    ...
    assert!(
        ...
        "ArchitectureError should have proper error message"
    );
    ...
    assert!(
        ...
        "GraphError should have proper error message"
    );
    ...
    assert!(
        err_msg.contains("test_layer"),
        "TensorError should include layer name"
    );
    println!("✓ TensorError::ShapePropagationFailed: \"{}\"", err_msg);

    let memory_err = MemoryError::VramOverflow {
        peak_gb: 100.0,
        gpu_gb: 80.0,
    };
    let err_msg = format!("{}", memory_err);
    assert!(
        err_msg.contains("100") && err_msg.contains("80"),
        "MemoryError should include values"
    );
    ...
    assert!(
        err_msg.contains("H2000"),
        "HardwareError should include GPU name"
    );
    ...
    println!(
        "│ {:<30} │ {:<60} │",
        "thiserror", "All derive macros working correctly"
    );
    println!("└─────────────────────────────────────────────────────────────────────────────────────────────────┘\n");
}
...
fn test_validation_errors() {
    ...
    println!(
        "│ {:<30} │ {:<60} │",
        "Validation", "All validation errors properly handled"
    );
    println!("└─────────────────────────────────────────────────────────────────────────────────────────────────┘\n");
}
...
fn test_error_recovery() {
    ...
    assert!(
        result.is_ok(),
        "Should recover and handle valid model after error"
    );
    ...
    assert!(
        result.is_ok(),
        "Should handle valid model after multiple errors"
    );
