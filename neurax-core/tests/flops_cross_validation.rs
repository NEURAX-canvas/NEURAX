...
fn test_flops_per_token_coherence() {
    ...
    println!(
        "✓ F01 corrigé: flops_per_token × {} = {:.3e} ≈ forward_flops = {:.3e}",
...
fn test_gpt2_small_flops_validation() {
    ...
    assert!(
        ...
        neurax_flops,
        paper_flops_detailed,
        error * 100.0
    );

    println!(
        "✓ GPT-2 Small FLOPs: NEURAX={:.3e}, paper_simplified={:.3e}, paper_detailed={:.3e}",
...
fn test_gpt2_medium_flops_validation() {
    ...
    println!(
        "✓ GPT-2 Medium FLOPs: NEURAX={:.3e}, paper_simplified={:.3e}, paper_detailed={:.3e}",
        neurax_flops, paper_flops_simplified, paper_flops_detailed
    );
}
