...
fn test_single_mlp_block() {
    ...
    // ── Parse ──────────────────────────────────────────────────────────
    let config = parse_model_config(SINGLE_MLP_JSON).expect("Failed to parse MLP JSON");
    ...
    println!(
        "│ Gate projection (H×I):  {:>12.0} params           │",
        gate_proj
    );
    println!(
        "│ Up projection (H×I):    {:>12.0} params           │",
        up_proj
    );
    println!(
        "│ Down projection (I×H):  {:>12.0} params           │",
        down_proj
    );
    println!("├─────────────────────────────────────────────────────────────┤");
    println!(
        "│ MLP TOTAL (SwiGLU):     {:>12.0} params           │",
        total_mlp
    );
    println!(
        "│                        {:>10.2}M                    │",
    ...
    println!(
        "│ Standard MLP (GELU):    {:>12.0} params  (2×H×I)  │",
        standard_mlp
    );
    println!(
        "│ SwiGLU MLP:             {:>12.0} params  (3×H×I)  │",
        swiglu_mlp
    );
    println!(
        "│ GLU MLP:                {:>12.0} params  (3×H×I)  │",
        glu_mlp
    );
    println!(
        "│ GeGLU MLP:              {:>12.0} params  (3×H×I)  │",
        geglu_mlp
    );
    println!("├─────────────────────────────────────────────────────────────┤");
    println!(
        "│ SwiGLU overhead:        {:>12.0} params (+50%)   │",
        swiglu_mlp - standard_mlp
    );
    println!("└─────────────────────────────────────────────────────────────┘\n");
    ...
    println!(
        "│ Down proj FLOPs:        {:>12.2e}                │",
        i * h
    );
    println!("├─────────────────────────────────────────────────────────────┤");
    println!(
        "│ Total MLP FLOPs/token:  {:>12.2e}                │",
        mlp_flops
    );
    println!(
        "│ Calculated FLOPs:       {:>12.2e}                │",
        flops as f64
    );
    println!("└─────────────────────────────────────────────────────────────┘\n");
    ...
    println!(
        "│   hidden_size:          {:>10?}                     │",
        arch_input.hidden_size
    );
    println!(
        "│   num_layers:           {:>10?}                     │",
        arch_input.num_layers
    );
    println!("├─────────────────────────────────────────────────────────────┤");
    println!("│ MemoryPass:                                             │");
    println!(
        "│   dtype_bytes:          {:>10}                     │",
        mem_config.dtype_bytes
    );
    println!(
        "│   optimizer_bytes:      {:>10}                     │",
        mem_config.optimizer_bytes
    );
    println!("└─────────────────────────────────────────────────────────────┘\n");
