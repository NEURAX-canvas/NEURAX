...
use neurax_mlir::{
    CpuBackend, CudaBackend, MetalBackend, RocmBackend, TargetLowering, VulkanBackend,
};
use std::fs;
...
fn main() {
    ...
    println!("----------------------------------");
    println!(
        "CPU module attributes:   {}",
        CpuBackend::module_attributes()
    );
    println!(
        "CPU function attributes: {}",
        CpuBackend::function_attributes()
    );
    println!(
        "CUDA module attributes:  {}",
        CudaBackend::module_attributes()
    );
    println!(
        "CUDA function attrs:     {}",
        CudaBackend::function_attributes()
    );
    println!(
        "ROCm module attributes:  {}",
        RocmBackend::module_attributes()
    );
    println!(
        "Metal module attributes: {}",
        MetalBackend::module_attributes()
    );
    println!(
        "Vulkan module attrs:     {}",
        VulkanBackend::module_attributes()
    );
    println!();
