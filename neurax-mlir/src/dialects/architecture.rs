...
impl ArchitectureDialect {
    ...
    pub fn model_full<'c>(
        ...
        OperationBuilder::new("arch.model", location)
            .add_attributes(&[
                ...
                (
                    Identifier::new(context, "version"),
                    string_attr(context, version),
                ),
                (
    ...
    pub fn layer_full<'c>(
        ...
        OperationBuilder::new("arch.layer", location)
            .add_attributes(&[
                ...
                (
                    Identifier::new(context, "input_shape"),
                    string_attr(context, &format!("{:?}", input_shape)),
                ),
                (
                    Identifier::new(context, "output_shape"),
                    string_attr(context, &format!("{:?}", output_shape)),
                ),
            ])
            .add_regions([Region::new()])
            .build()
    ...
    pub fn global_params<'c>(
        ...
        let attrs: Vec<(Identifier, _)> = params
            .iter()
    ...
    pub fn global_params_full<'c>(
        ...
        OperationBuilder::new("arch.global_params", location)
            .add_attributes(&[
                ...
                (
                    Identifier::new(context, "intermediate_size"),
                    int_attr(context, intermediate_size),
                ),
                (
                    Identifier::new(context, "num_attention_heads"),
                    int_attr(context, num_attention_heads),
                ),
                (
                    Identifier::new(context, "num_key_value_heads"),
                    int_attr(context, num_key_value_heads),
                ),
                (
                ...
                (
                    Identifier::new(context, "sequence_length"),
                    int_attr(context, sequence_length),
                ),
                (
                ...
                (
                    Identifier::new(context, "layer_norm_eps"),
                    float_attr(context, layer_norm_eps),
                ),
            ])
            .build()
    }
    ...
    pub fn metrics_full<'c>(
        ...
        OperationBuilder::new("arch.metrics", location)
            .add_attributes(&[
                ...
                (
                    Identifier::new(context, "num_attention_layers"),
                    int_attr(context, num_attention_layers),
                ),
                (
                    Identifier::new(context, "num_mlp_layers"),
                    int_attr(context, num_mlp_layers),
                ),
                (
                    Identifier::new(context, "num_embedding_layers"),
                    int_attr(context, num_embedding_layers),
                ),
                (
                    Identifier::new(context, "num_normalization_layers"),
                    int_attr(context, num_normalization_layers),
                ),
                (
                    Identifier::new(context, "model_size_mb"),
                    float_attr(context, model_size_mb),
                ),
            ])
            .build()
    }
    ...
    pub fn layer_params<'c>(
        ...
        OperationBuilder::new("arch.layer_params", location)
            .add_attributes(&[
                ...
                (
                    Identifier::new(context, "flops_per_token"),
                    float_attr(context, flops_per_token),
                ),
                (
    ...
    pub fn model_family<'c>(
        ...
        OperationBuilder::new("arch.model_family", location)
            .add_attributes(&[
                (
                    Identifier::new(context, "family"),
                    string_attr(context, family),
                ),
                (
                    Identifier::new(context, "base_model"),
                    string_attr(context, base_model),
                ),
                (
                    Identifier::new(context, "variant"),
                    string_attr(context, variant),
                ),
            ])
            .build()
    }
    ...
    pub fn repeat<'c>(
        ...
        OperationBuilder::new("arch.repeat", location)
            .add_attributes(&[(Identifier::new(context, "count"), int_attr(context, count))])
        ...
        OperationBuilder::new("arch.layer_pattern", location)
            .add_attributes(&[
                (
                    ...
                    string_attr(context, pattern_name),
                ),
                (
                    Identifier::new(context, "layer_types"),
                    string_attr(context, &layers_str),
                ),
            ])
            .build()
    }
