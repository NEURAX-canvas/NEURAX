...
impl ComputeDialect {
    ...
    pub fn flops<'c>(
        ...
        OperationBuilder::new("compute.flops", location)
            .add_attributes(&[
                (
                    Identifier::new(context, "forward_flops"),
                    float_attr(context, forward_flops),
                ),
                (
                    Identifier::new(context, "backward_flops"),
                    float_attr(context, backward_flops),
                ),
            ])
            .build()
    }
    ...
    pub fn intensity<'c>(
        ...
        OperationBuilder::new("compute.intensity", location)
            .add_attributes(&[
                ...
                (
                    Identifier::new(context, "bytes_accessed"),
                    int_attr(context, bytes_accessed),
                ),
                (
                    Identifier::new(context, "intensity"),
                    float_attr(context, intensity),
                ),
            ])
            .build()
    }
    ...
    pub fn complexity<'c>(
        ...
        OperationBuilder::new("compute.complexity", location)
            .add_attributes(&[(
                Identifier::new(context, "complexity_class"),
                string_attr(context, complexity_class),
            )])
            .build()
    }
    ...
    pub fn metrics<'c>(
        ...
        OperationBuilder::new("compute.metrics", location)
            .add_attributes(&[
                ...
                (
                    Identifier::new(context, "arithmetic_intensity"),
                    float_attr(context, arithmetic_intensity),
                ),
                (
                    Identifier::new(context, "forward_flops"),
                    float_attr(context, forward_flops),
                ...
                (
                    Identifier::new(context, "optimizer_flops"),
                    float_attr(context, optimizer_flops),
                ),
                (
                    Identifier::new(context, "total_step_flops"),
                    float_attr(context, total_step_flops),
                ),
            ])
            .build()
    }
