...
impl CostDialect {
    ...
    pub fn pricing_model<'c>(
        ...
        OperationBuilder::new("cost.pricing", location)
            .add_attributes(&[
                (
                    Identifier::new(context, "gpu_hour_usd"),
                    float_attr(context, gpu_hour_usd),
                ),
                (
                    Identifier::new(context, "energy_kwh_usd"),
                    float_attr(context, energy_kwh_usd),
                ),
                (
                    Identifier::new(context, "pue_factor"),
                    float_attr(context, pue_factor),
                ),
                (
                    Identifier::new(context, "gpu_tdp_watts"),
                    float_attr(context, gpu_tdp_watts),
                ),
                (
                    Identifier::new(context, "co2_per_kwh"),
                    float_attr(context, co2_per_kwh),
                ),
            ])
            .build()
    }
    ...
    pub fn pricing_full<'c>(
        ...
        OperationBuilder::new("cost.pricing", location)
            .add_attributes(&[
                (
                    Identifier::new(context, "provider"),
                    string_attr(context, provider),
                ),
                (
                    Identifier::new(context, "gpu_hour_usd"),
                    float_attr(context, gpu_hour_usd),
    ...
    pub fn training_cost<'c>(
        ...
        OperationBuilder::new("cost.training", location)
            .add_attributes(&[
                (
                    Identifier::new(context, "training_time_hours"),
                    float_attr(context, training_time_hours),
                ),
                (
                ...
                (
                    Identifier::new(context, "gpu_hours_total"),
                    float_attr(context, gpu_hours_total),
                ),
            ])
            .build()
    }
    ...
    pub fn energy<'c>(
        ...
        OperationBuilder::new("cost.energy", location)
            .add_attributes(&[
                (
                    Identifier::new(context, "energy_kwh"),
                    float_attr(context, energy_kwh),
                ),
                (
                    Identifier::new(context, "co2_kg"),
                    float_attr(context, co2_kg),
                ),
            ])
            .build()
    }
    ...
    pub fn token_cost<'c>(
        ...
        OperationBuilder::new("cost.token_cost", location)
            .add_attributes(&[(
                Identifier::new(context, "cost_per_million_tokens_usd"),
                float_attr(context, cost_per_million_tokens_usd),
            )])
            .build()
    }
