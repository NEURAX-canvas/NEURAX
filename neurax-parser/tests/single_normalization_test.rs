...
fn test_single_normalization_block() {
    ...
    // ── Parse ──────────────────────────────────────────────────────────
    let config = parse_model_config(SINGLE_NORM_JSON).expect("Failed to parse normalization JSON");
