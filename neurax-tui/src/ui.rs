...
fn draw_model_selector(f: &mut Frame, app: &App, area: Rect) {
    ...
    f.render_stateful_widget(
        list,
        chunks[0],
        &mut ratatui::widgets::ListState::default().with_selected(Some(app.selected_model)),
    );
    ...
    let instructions = Paragraph::new(vec![
        ...
        Line::from(vec![
            Span::styled("│", Style::default().fg(Color::Cyan)),
            Span::styled(
                "  This tool compiles neural network models and produces       ",
                Style::default().fg(Color::White),
            ),
            Span::styled("│", Style::default().fg(Color::Cyan)),
        ]),
        Line::from(vec![
            Span::styled("│", Style::default().fg(Color::Cyan)),
            Span::styled(
                "  77 metrics across 9 IR modules:                             ",
                Style::default().fg(Color::White),
            ),
            Span::styled("│", Style::default().fg(Color::Cyan)),
        ]),
        ...
        Line::from(vec![
            Span::styled("│", Style::default().fg(Color::Cyan)),
            Span::styled(
                "  • Architecture: 5 metrics   • Graph: 6 metrics              ",
                Style::default().fg(Color::Gray),
            ),
            Span::styled("│", Style::default().fg(Color::Cyan)),
        ]),
        Line::from(vec![
            Span::styled("│", Style::default().fg(Color::Cyan)),
            Span::styled(
                "  • Tensor: 9 metrics        • Operator: 5 metrics          ",
                Style::default().fg(Color::Gray),
            ),
            Span::styled("│", Style::default().fg(Color::Cyan)),
        ]),
        Line::from(vec![
            Span::styled("│", Style::default().fg(Color::Cyan)),
            Span::styled(
                "  • Compute: 12 metrics      • Memory: 11 metrics            ",
                Style::default().fg(Color::Gray),
            ),
            Span::styled("│", Style::default().fg(Color::Cyan)),
        ]),
        Line::from(vec![
            Span::styled("│", Style::default().fg(Color::Cyan)),
            Span::styled(
                "  • Parallelism: 10 metrics  • Hardware: 10 metrics          ",
                Style::default().fg(Color::Gray),
            ),
            Span::styled("│", Style::default().fg(Color::Cyan)),
        ]),
        ...
        Line::from(vec![
            Span::styled("│", Style::default().fg(Color::Cyan)),
            Span::styled(
                "  Each metric is compared against real-world data from       ",
                Style::default().fg(Color::White),
            ),
            Span::styled("│", Style::default().fg(Color::Cyan)),
        ]),
        ...
        Line::from(vec![
            Span::styled("│", Style::default().fg(Color::Cyan)),
            Span::styled(
                "  Keys: [↑/↓] Navigate  [Enter] Compile  [Tab] Switch Tab    ",
        ...
        Line::from(vec![
            Span::styled("│", Style::default().fg(Color::Cyan)),
            Span::styled(
                "        [1-7] Jump to Tab  [r] Refresh  [q] Quit             ",
                Style::default().fg(Color::Yellow),
            ),
            Span::styled("│", Style::default().fg(Color::Cyan)),
        ]),
...
fn draw_overview(
    f: &mut Frame,
    _app: &App,
    result: &neurax_core::AnalysisResult,
    real: &crate::real_world_data::RealWorldData,
    area: Rect,
) {
    ...
    let model_info = Paragraph::new(vec![
        ...
        Line::from(vec![
            ...
            Span::styled(
                &result.arch.metrics.model_type_info,
                Style::default().fg(Color::White),
            ),
        ]),
        Line::from(vec![
            ...
            Span::styled(
                metrics_display::format_number(result.arch.metrics.total_parameters as f64),
                Style::default().fg(Color::Green),
            ),
            Span::raw(" (Real: "),
            Span::styled(
                metrics_display::format_number(real.total_params as f64),
                Style::default().fg(Color::Yellow),
            ),
            Span::raw(")"),
        ]),
        Line::from(vec![
            ...
            Span::styled(
                format!("{}", result.arch.metrics.num_layers),
                Style::default().fg(Color::White),
            ),
        ]),
        Line::from(vec![
            ...
            Span::styled(
                format!("{} ms", result.analysis_time_ms),
                Style::default().fg(Color::White),
            ),
        ]),
    ])
    ...
    let ir_status = Paragraph::new(vec![
        ...
        Line::from(""),
        Line::from(vec![Span::styled(
            "All 9 IR modules validated successfully",
            Style::default().fg(Color::Green),
        )]),
    ])
...
fn draw_comparison(
    ...
    let source_info = Paragraph::new(vec![
        ...
        Line::from(vec![
            ...
            Span::styled(
                format!("{} x {}", real.gpu_count, real.gpu_type),
                Style::default().fg(Color::White),
            ),
        ]),
        Line::from(""),
        Line::from(vec![
            ...
            Span::styled(
                metrics_display::format_number(real.training_tokens as f64),
                Style::default().fg(Color::White),
            ),
        ]),
    ])
    .block(
        Block::default()
            .title("Real-World Reference Data")
            .borders(Borders::ALL),
    );
